...
const GroupDetailView: React.FC = () => {
  ...
  return (
    <div className="mx-auto rounded-xl border border-gray-100 bg-white p-8 shadow-lg">
            ...
            <div>
              ...
              <div className="mb-4 flex flex-col gap-y-2 text-sm text-gray-500">
                <div className="flex items-center">
                  ...
                  <span>
                    Ngày tạo nhóm:{" "}
                    {formatDate(groupDetail?.createdDate || "2023-01-01")}
                  </span>
                </div>
                <div className="flex items-center">
            ...
            <div className="flex gap-3">
              <span
                className={`rounded-full px-4 py-1 text-sm font-medium transition-all duration-200 hover:opacity-80 ${
                  handler.formatStatus(groupDetail?.status).color
                } shadow-sm`}
              >
                {handler.formatStatus(groupDetail?.status).label}
              </span>
              <span
                className={`rounded-full px-4 py-1 text-sm font-medium shadow-sm transition-all duration-200 hover:opacity-80 ${
                  groupDetail?.visibility === "PRIVATE"
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-lg border border-gray-100 bg-gray-50 p-4 shadow-sm transition-all hover:border-gray-200">
              ...
              <p className="text-green-600 text-2xl font-bold">
                {formatCurrency(groupDetail?.currentBalance)}
              </p>
            </div>
          </div>
        </div>
      ...
      <GroupStats groupDetail={groupDetail} />
      <div className="mb-12">
        <div className="mb-6">
                      ...
                      <div className="flex items-center">
                        <div className="relative h-10 w-10 flex-shrink-0">
                          {member?.userInfo?.avatarUrl ? (
                            ...
                            <div className="flex h-10 w-10 items-center justify-center rounded-full border border-gray-200 bg-gradient-to-br from-gray-200 to-gray-300">
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {groupDetail?.groupMembers?.map((member: GroupMembers) => (
            <div
              ...
              <div className="mb-4 flex items-center">
                <div className="relative h-16 w-16 flex-shrink-0">
                  {member?.userInfo?.avatarUrl ? (
                    ...
                    <div className="flex h-16 w-16 items-center justify-center rounded-full border-2 border-white bg-gradient-to-br from-blue-100 to-gray-200 shadow-sm">
              ...
              <div className="space-y-3 text-sm">
                ...
                {member?.userInfo?.gender !== null && (
                  <div className="grid grid-cols-2 rounded-lg bg-gray-50 p-2">
                    ...
                    <span className="text-gray-900">
                      {handler.formatGender(member?.userInfo?.gender as any)}
                    </span>
                  </div>
                )}
                ...
                <div className="grid grid-cols-2 rounded-lg bg-gray-50 p-2">
                  <span className="font-medium text-gray-500">Đóng góp:</span>
                  <div className="flex items-center">
